<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class=" shadow-sm rounded-lg p-6">
                ...
                <div class="mt-8 bg-white rounded shadow p-4">
                    <h3 id="chartTitle">Monthly Sales for {{ date('F') }} {{ date('Y') }}</h3> <!-- Initial title -->
    ...
    <script>
        ...
        function updateTitle() {
            ...
            $('#chartTitle').text(`Monthly Sales for ${monthName} ${year}`);
        }
        ...
        function updateChart(salesData) {
            ...
            const dataValues = salesData.map(data => data.quantity);

            if (salesChart) {
                salesChart.destroy(); // Destroy the old chart instance
            }
        ...
        $(document).ready(function() {
            ...
            // Initial fetch to display chart with default values
            fetchSalesData();
        });
    </script>
