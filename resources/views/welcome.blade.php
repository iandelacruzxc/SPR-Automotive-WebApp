...
.carousel-item {
    flex: 0 0 auto;
    width: 25%; /* Show 4 cards at a time */
}
...
.custom-banner-height {
                    ...
                    <div class="flex flex-col items-center mt-10 space-y-6">
                        ...
                        @if (Route::has('login'))
                            ...
                            @else
                                ...
                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}" class="text-white text-lg hover:text-gray-400">Register</a>
                                @endif
                            @endauth
                        @endif
                    </div>
    ...
    <!-- Main Banner -->
    <section class="relative bg-cover bg-center custom-banner-height" style="background-image: url('{{ asset('images/main-banner.png') }}'); background-size: cover; background-position: center;">
        ...
        <div class="carousel-wrapper relative overflow-hidden">
            <div class="carousel-track flex transition-transform duration-500 ease-in-out">
                ...
                <div class="carousel-item flex-shrink-0 w-64 h-40 bg-gray-200 mx-2 rounded-lg shadow-lg">
                    <img src="https://via.placeholder.com/256x160" alt="Image 1" class="w-full h-full object-cover rounded-lg">
                    <div class="p-4">
                ...
                <div class="carousel-item flex-shrink-0 w-64 h-40 bg-gray-200 mx-2 rounded-lg shadow-lg">
                    <img src="https://via.placeholder.com/256x160" alt="Image 2" class="w-full h-full object-cover rounded-lg">
                    <div class="p-4">
                ...
                <div class="carousel-item flex-shrink-0 w-64 h-40 bg-gray-200 mx-2 rounded-lg shadow-lg">
                    <img src="https://via.placeholder.com/256x160" alt="Image 3" class="w-full h-full object-cover rounded-lg">
                    <div class="p-4">
                ...
                <div class="carousel-item flex-shrink-0 w-64 h-40 bg-gray-200 mx-2 rounded-lg shadow-lg">
                    <img src="https://via.placeholder.com/256x160" alt="Image 4" class="w-full h-full object-cover rounded-lg">
                    <div class="p-4">
                ...
                <div class="carousel-item flex-shrink-0 w-64 h-40 bg-gray-200 mx-2 rounded-lg shadow-lg">
                    <img src="https://via.placeholder.com/256x160" alt="Image 5" class="w-full h-full object-cover rounded-lg">
                    <div class="p-4">
      ...
      <section class="my-12 relative">
        <div class="flex flex-col md:flex-row items-center relative">
            ...
            <div class="w-full md:w-1/2 mb-8 md:mb-0 relative">
                <img src="{{ asset('images/about-us.png') }}" alt="Company Image" class="w-full h-auto rounded-lg shadow-lg object-cover">
                
                <!-- Floating Container -->
                <div class="absolute top-1/4 right-0 transform translate-x-[95%] bg-white bg-opacity-90 p-8 rounded-lg shadow-xl shadow-black h-[500px] flex flex-col justify-center">
                    <h2 class="text-3xl font-bold mb-4">About Our Company</h2>
                    <p class="text-lg mb-6">
                        We are a leading company in the industry, dedicated to providing top-notch services and innovative solutions to our customers.
                    </p>
                    <p class="text-lg mb-6">
                        With years of experience and a commitment to excellence, we have established ourselves as a trusted name in the market.
                    </p>
                    <p class="text-lg">
                        Our vision is to continue growing and evolving with the times, always keeping our customers at the heart of everything we do.
                    </p>
                </div>
            </div>
        </div>
...
<script>
 $(document).ready(function() {
    ...
    for (let i = 0; i < totalPages; i++) {
        $('.indicator-container').append(`<span class="dot w-3 h-3 bg-gray-400 rounded-full mx-1 cursor-pointer" data-slide="${i}"></span>`);
    }
...
<footer class="bg-white text-black py-6">
    <div class="container mx-auto flex flex-col md:flex-row justify-between items-center">
        ...
        <div class="flex space-x-4 mt-4 md:mt-0">
            ...
            <a href="#" class="text-gray-400 hover:text-white">
                <i class="fab fa-linkedin-in"></i> <!-- Font Awesome Icon -->
            </a>
        </div>
    </div>
