        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm rounded-lg p-6">
                <div class="flex justify-between items-center mb-4">
                    <a href="/inventory" class="inline-flex items-center bg-gray-300 text-gray-800 py-2 px-4 rounded-md hover:bg-gray-400 transition duration-200">
                ...
                <div class="flex flex-col md:flex-row gap-4">
                    ...
                    <div class="flex-1">
                        <div class="bg-white border border-gray-200 rounded-lg shadow-md p-4 flex flex-col">
                            <img src="{{ asset('storage/' . $product->image_path) }}" alt="{{ $product->name }}" class="w-full h-64 object-cover rounded-md mb-4"> <!-- Full width image -->
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ optional($product->inventory)->quantity ?? '0' }}</td>
                                    </tr>
                                    <tr>
