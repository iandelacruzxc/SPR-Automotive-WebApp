    ...
    <div id="addModal" class="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center hidden">
      <div class="bg-white p-4 rounded-lg shadow-lg max-w-5xl w-full">
          <h3 id="product_modal_title" class="text-lg font-bold mb-4">Add Product</h3>
          <form id="add_transaction_product">
              <div id="addModalBody" class="h-[28rem] pl-4 overflow-y-scroll">
                  <!-- Form fields (same as the create modal, but with different IDs for the inputs) -->
                  <div class="font-semibold mb-4">Client Information</div>
                  <div class="grid grid-cols-2 gap-2 mb-8">
                      <div class="col-span-2">
