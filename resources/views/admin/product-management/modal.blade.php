            ...
            <div class="w-full md:w-1/3 flex flex-col items-center">
                <div class="mb-4 w-full">
                    ...
                    <input type="file" id="imageUpload" name="image"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm sm:text-sm" accept="image/*"
                        onchange="previewImage(event)">
                </div>

                <!-- Image Preview -->
                <div
                    class="mb-4 w-full h-40 bg-gray-100 flex items-center justify-center border border-gray-300 rounded-md shadow-sm">
