...
.group:hover .carousel-btn {
    ...
    <!-- Main Banner -->
    <section class="relative bg-cover bg-center h-96" style="background-image: url('https://via.placeholder.com/1500x600');">
        ...
        <div class="relative container mx-auto flex items-center justify-center h-full">
            <div class="text-center text-white px-4">
                ...
                <a href="#learn-more" class="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded-lg">Learn More</a>
            </div>
        </div>
    </section>
    <!-- End Main Banner -->
      ...
      <section class="my-12">
        <div class="flex flex-col md:flex-row items-center">
            ...
            <div class="w-full md:w-1/2 mb-8 md:mb-0">
                <img src="https://via.placeholder.com/400x400" alt="Company Image" class="w-full h-auto rounded-lg shadow-lg object-cover">
            </div>
